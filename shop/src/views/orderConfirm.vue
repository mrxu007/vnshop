<template>
  <div class="orderConfirm">
    <Header/>
    <NavBread><span>订单详情</span></NavBread>
    <div>
      ...
      <div class="checkout-order">
        ...
        <div class="item-list-wrap confirm-item-list-wrap">
          <div class="cart-item order-item">
            ...
            <ul class="cart-item-list">
              <li v-for="(item , index ) in newCartList" :key="index">
                ...
                <div class="cart-tab-3">
                  <div class="item-quantity">
                    ...
                    <div class="item-stock item-stock-no">现在有货
                    </div>
                  </div>
                </div>
        ...
        <div class="order-foot-wrap">
          <div class="prev-btn-wrap">
            <router-link class="btn btn--m btn--red" :to="{ path : '/address'}">上一步</router-link>
          </div>
      ...
      methods: {
        ...
        getOrder(){
          this.$http.post('/users/cartList').then((res)=>{
            ...
            this.orderTotal = (this.subTotal + this.tax +this.shopping) * this.discount
          })
        },
        //确认订单
        payment(){
          ...
          this.$http.post('/users/payment',{
            ...
            orderTotal : this.orderTotal
              ...
              if(results.status == 0){
                this.$router.push({
                  path:'/orderSuccess?orderId='+ results.result.orderId
                })
              }
          })
