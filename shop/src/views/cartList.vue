              ...
              <li v-for="(item , index) in cartList" :key="index">
                ...
                <div class="cart-tab-5">
                  <div class="cart-item-opration">
                    <a href="javascript:;" class="item-edit-btn" @click="productDel(item.productId)">
        ...
        <div class="cart-foot-wrap">
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
                <a class="btn btn--red totalMoney" @click=" checkOut">结算</a>
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      //删除商品
      productDel(productId){
        this.$http.post('/users/cartListDel',{
          productId : productId
        }).then((res)=>{
          let results = res.data
          if(results.status == 0){
