<template>
  <div class="Header">
    <div class="site-header" style="clear:both;">
      <div class="container">
        <div class="header-logo">
          <a href="#" title="小米官网"><img src="../assets/img/vn-logo.png" /></a>
        </div>
        <div class="header-nav">
          <ul class="nav-list">
            ...
            <li class="nav-item">
              <a class="link" href="category.php?id=76"><span>所有代码自动更新上线,用户名admin 密码 1234563333</span></a>
    ...
    <!--登录框模块-->
    <el-dialog title="登录" :visible.sync="formAll.dialogFormVisible" v-if="formAll.dialogFormVisible" >
      <el-form :model="formAll.form" id="login_form">
        ...
        <el-form-item label="密码" :label-width="formAll.formLabelWidth">
          <el-input v-model="formAll.form.password" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
